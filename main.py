...
import os
import pygame
from pygame.constants import QUIT, K_DOWN, K_UP, K_LEFT, K_RIGHT, K_a, K_d, K_s, K_w
...
# player_rect = pygame.Rect(0 , ( HEIGHT - player.get_height()), *player_size) #player.get_rect()
...
def create_bonus():
    ...
    bonus_rect = pygame.Rect(random.randint(bonus_width, WIDTH - bonus.get_height()), -bonus.get_height(), *bonus.get_size())
